  ...
  return (
    <article className={styles.info}>
      <div className={styles.buttonsLine}>
        <div className={styles.buttons} onClick={() => setCount("1")}>
          Studio Garden
        </div>
        <div className={styles.buttons} onClick={() => setCount("2")}>
          Studio
        </div>
        <div className={styles.buttons} onClick={() => setCount("3")}>
          Cobertura
        </div>
      </div>
      {count === "1" && 
      <div className={styles.aps}>
        <img src="images/interior-studio.jpg" alt="" srcset="" />
        <h1>Studio Garden</h1>
